...
# алгоритм Канни без пороговой фильтрации
...
def main(path, standard_deviation, kernel_size):
    ...
    # запись в файл
    cv2.imwrite('result_pictures/res_test2_3.jpg', img_border)
...
# main('dataset/test2.jpg',7, 19)
# main('dataset/test2.jpg',15, 5)
main('dataset/test2.jpg',150, 9)
